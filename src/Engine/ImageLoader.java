...
public class ImageLoader {
    ...
    public static BufferedImage load(String imageFileName, Color transparentColor) {
        try {
            BufferedImage initialImage = ImageIO.read(ImageLoader.class.getResourceAsStream(Config.RESOURCES_PATH + imageFileName));
    ...
    public static BufferedImage loadSubImage(String imageFileName, Color transparentColor, int x, int y, int width, int height) {
        try {
            BufferedImage initialImage = ImageIO.read(Config.class.getResourceAsStream(Config.RESOURCES_PATH + imageFileName));
